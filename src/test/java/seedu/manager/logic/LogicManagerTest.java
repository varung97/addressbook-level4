...
public class LogicManagerTest {
    ...
    public void execute_add_invalidArgsFormat() throws Exception {
        ...
        assertCommandBehavior(
                "add Valid Desc 12345 e/valid@email.butNoPhonePrefix a/med", expectedMessage);
        assertCommandBehavior(
                "add Valid Desc p/12345 valid@email.butNoPrefix a/low", expectedMessage);
        assertCommandBehavior(
                "add Valid Desc p/12345 e/valid@email.butNoAddressPrefix low", expectedMessage);
    }
    ...
    public void execute_add_invalidTaskData() throws Exception {
        ...
        assertCommandBehavior(
                "add Valid Desc p/12345 e/notAnEmail a/med", Email.MESSAGE_EMAIL_CONSTRAINTS);
        assertCommandBehavior(
    ...
    class TestDataHelper{
        ...
        Task adam() throws Exception {
            ...
            return new Task(desc, privatePhone, email, privatePriority, tags);
        }
